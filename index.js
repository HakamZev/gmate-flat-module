...
const GMATE_LEADERS = ['K02', 'K05', 'K19', 'K20', 'K21']
...
function orderedItems() {
  let array = []
  const _groupedKeys = groupedKeys()
  for (let k in _groupedKeys) {
    array.push({ type: 'kondisi', key: k })
    for (let s of _groupedKeys[k]) {
      array.push({ type: 'soal', key: s })
    }
  }
  return array
}
...
exports.groupedKeys = groupedKeys
